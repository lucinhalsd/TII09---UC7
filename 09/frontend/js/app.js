const apiUrlBase = 'http://localhost/luci/TII09---UC7/09/api/clientes_api.php'; // Ajuste se necessário
...
if (document.getElementById('formCliente')) {
    ...
    formCliente.addEventListener('submit', function(event) {
        ...
        const dados = {
            ...
            cpf: cpfInput.value,
            dataDeNascimento: dataNascInput.value,
...
// Conteúdo existente do app.js (para clientes) ...
// ... (mantenha a apiUrlBase e exibirMensagem)
...
if (document.getElementById('formProduto')) {
    ...
    formProduto.addEventListener('submit', function(event) {
        ...
        const dadosProduto = {
            ...
            ativo: produtoAtivoInput.checked
        };
        ...
        .then(data => {
            if (data.error) {
                ...
                exibirMensagem(data.message || 'Operacao realizada com sucesso!', 'sucesso');
                if (method === 'POST' && !data.error) { // Limpa form só no cadastro
                    formProduto.reset();
                }
