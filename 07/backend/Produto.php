...
class Produto
{
    private ?int $id;   //(?int) o id pode ser nulo pq ainda nao está cadastrado no banco de dados
    private string $nome;
    private float $preco;
    private bool $ativo;
    ...
    public function setAtivo(bool $ativo)  {  $this->ativo = ; }
    public function setDataDeCadastro(string $cadastro)  {  $this->dataDeCadastro = ; }
    public function setDataDeValidade(string $validade) {  $this->dataDeValidade = ; }
}